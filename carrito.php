...
if (!$carrito_vacio) {
    foreach ($_SESSION['carrito'] as $item) {
        ...
        $tiempo_total = max($tiempo_total, $item['tiempo_preparacion']);
    }
}
?>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <small class="text-muted"><?php echo $item['tiempo_preparacion']; ?> min preparación</small>
                                    </td>
                                    ...
                                    <td>
                                        <form method="POST">
                                            ...
                                            <input type="number" name="nueva_cantidad" value="<?php echo $item['cantidad']; ?>" min="1"
                                                class="form-control form-control-sm" style="width: 70px; align-content: center; text-align: center;"
                ...
                <div class="resumen-pedido sticky-top">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="d-flex justify-content-between">
                            <strong>Total:</strong>
                            <strong>€<?php echo number_format($total + ($total >= 15 ? 0 : 1.50), 2); ?></strong>
                        </div>
                    </div>
